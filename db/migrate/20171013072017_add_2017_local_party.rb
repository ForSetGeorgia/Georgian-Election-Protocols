class Add2017LocalParty < ActiveRecord::Migration
  def up
    ...
    Election.transaction do
      election = Election.new(
        ...
        election_app_event_id: 51,
        parties_same_for_all_districts: true,
        ...
        party_file: File.open("#{csv_path}2017_party_list_parties.csv"),
        ...
        tmp_analysis_table_name: '2017 Local - Party List'
      )
      election.election_translations.build(locale: 'en', name: '2017 Local Election - Party List')
      election.election_translations.build(locale: 'ka', name: '2017 წლის ადგილობრივი თვითმმართველობის არჩევნები - პარტიული სია')
      election.save
