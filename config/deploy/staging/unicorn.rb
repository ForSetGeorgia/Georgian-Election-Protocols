...
##### SET THESE VARIABLES ########
##################################
root = "/home/protocols-staging/Protocols-Staging/current" # path to application current folder
sock_name = "unicorn_Protocols-Staging" # must be unique name with no '.'
