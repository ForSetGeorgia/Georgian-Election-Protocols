...
set :application, "Protocols-Staging" # unique name of application
set :user, "protocols-staging" # name of user on server
...
set :git_branch_name, "queue" # name of branch to deploy
